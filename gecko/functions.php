...
function extra_widgets_init() {
      if ( ! function_exists( 'register_sidebars' ) )
		...
		register_sidebar( array( 'name' => __( 'Widget Page Template', 'woothemes' ), 'id' => 'widget-page-template', 'description' => __( 'Widgetized Page Template', 'woothemes' ), 'before_widget' => '<div id="%1$s" class="%2$s">', 'after_widget' => '</div>', 'before_title' => '<h3>', 'after_title' => '</h3>' ) );			
